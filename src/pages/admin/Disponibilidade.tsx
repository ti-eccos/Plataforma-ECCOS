...
import { AlertCircle, CalendarX, CalendarPlus, Check, X } from "lucide-react";

// Componente para renderizar o ícone de certo (adicionar) sobre as datas
const AddDateIcon = () => (
...
// Componente para renderizar o ícone de errado (remover) sobre as datas
...
export default function Disponibilidade() {
  ...
  const isDateSelectedForAdd = (date: Date) => {
    return selectedAddDates.some(selectedDate => 
      selectedDate.toISOString() === date.toISOString()
    );
  };

  const isDateSelectedForRemove = (date: Date) => {
    return selectedRemoveDates.some(selectedDate => 
      selectedDate.toISOString() === date.toISOString()
    );
  };
  ...
  return (
    <AppLayout>
      <div className="max-w-full mx-auto p-3 sm:p-4 space-y-4">
                  ...
                  disabled={(date) => 
                    ...
                    components={{
                      DayContent: (props) => {
                        ...
                        // Renderize o número do dia no calendário
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-1 text-xs text-gray-600">
                    ...
                    <p>
                      ...
                      <Check className="h-3 w-3 inline mx-1 text-blue-600 stroke-[3]" /> Datas a adicionar • 
                      Dia atual: cinza • Selecione apenas datas futuras
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-3 pt-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-1 text-xs text-gray-600">
                    ...
                    <p>
                      Datas verdes: disponíveis • 
                      <X className="h-3 w-3 inline mx-1 text-red-600 stroke-[3]" /> Datas a remover • 
                      Apenas datas disponíveis podem ser removidas
                    </p>
                  </div>
                </div>
              </CardContent>
