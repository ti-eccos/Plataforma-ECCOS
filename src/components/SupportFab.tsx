  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Dialog open={open} onOpenChange={handleOpenChange}>
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] bg-white border border-gray-100 shadow-2xl rounded-2xl overflow-hidden">
          ...
          <div className="flex flex-col h-full max-h-[calc(90vh-2rem)] overflow-hidden">
            <DialogHeader className="relative z-10 flex-shrink-0 p-6 pb-0">
            ...
            <div className="relative z-10 flex-1 overflow-y-auto px-6 pb-6 mt-6 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList className="grid w-full grid-cols-2 bg-gray-50 rounded-xl p-1 sticky top-0 z-20 mb-6">
                  <TabsTrigger 
                    value="manuals" 
                ...
                <TabsContent value="bugReport" className="mt-0">
                  <div className="bg-white border border-gray-100 rounded-2xl shadow-lg p-6">
                    <h3 className="font-bold text-xl mb-6 flex items-center gap-3 bg-gradient-to-r from-sidebar to-eccos-purple bg-clip-text text-transparent">
