  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          // Posicionamento centralizado e animações
          ...
          // Estilos customizáveis via className
          className
        )}
        {...props}
      >
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left p-6 pb-4 border-b border-gray-100",
      className
    )}
    {...props}
  />
