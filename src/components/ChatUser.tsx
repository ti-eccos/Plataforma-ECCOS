...
const ChatUser = ({ request, isOpen, onOpenChange, onMessageSent }: ChatUserProps) => {
        ...
        <DialogHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              {request && (
                <DialogDescription>
                  {getReadableRequestType(request.type)} - {format(
              ...
              {messages.length > 0 ? (
                messages.map((msg, index) => (
                  ...
                  >
                    ...
                    {msg.attachment && (
                      <div className={`mb-2 p-2 rounded border ${msg.isAdmin ? 'bg-white/10 border-white/20' : 'bg-black/5 border-black/10'}`}>
